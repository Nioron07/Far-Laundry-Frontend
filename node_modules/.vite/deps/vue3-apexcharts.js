  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
        ...
        for (var p2 = t3; p2 < a2; p2++) {
          ...
          for (var m3 = x2; m3 <= b2 && m3 < r2.series[p2].length; m3++) {
            ...
            if (null !== y2 && v.isNumber(y2)) {
              ...
              }), v.isFloat(y2) && (y2 = v.noExponents(y2), r2.yValueDecimal = Math.max(r2.yValueDecimal, y2.toString().split(".")[1].length)), o2 > h3[p2][m3] && h3[p2][m3] < 0 && (o2 = h3[p2][m3]);
    ...
    var xa = function() {
      ...
      return s(t2, [{ key: "init", value: function() {
        ...
        for (var n2 = e2.globals.legendFormatter, o2 = e2.config.legend.inverseOrder, l2 = o2 ? a2.length - 1 : 0; o2 ? l2 >= 0 : l2 <= a2.length - 1; o2 ? l2-- : l2++) {
          var h3, c2 = n2(a2[l2], { seriesIndex: l2, w: e2 }), d2 = false, u2 = false;
          ...
          m3 || (m3 = e2.config.chart.foreColor), b2.style.color = m3, b2.style.fontSize = parseFloat(e2.config.legend.fontSize) + "px", b2.style.fontWeight = e2.config.legend.fontWeight, b2.style.fontFamily = i2 || e2.config.chart.fontFamily, Mi.setAttrs(b2, { rel: l2 + 1, i: l2, "data:default-text": encodeURIComponent(c2), "data:collapsed": d2 || u2 }), x2.appendChild(f2), x2.appendChild(b2);
    ...
    var ma = function(t2) {
      ...
      return s(a2, [{ key: "init", value: function(t3) {
        ...
        var e3 = t3.context, i2 = t3.zoomtype, a3 = this.w, s2 = e3, r2 = this.gridRect.getBoundingClientRect(), n2 = s2.startX - 1, o2 = s2.startY, l2 = false, h3 = false, c2 = s2.clientX - r2.left - n2, d2 = s2.clientY - r2.top - o2, g2 = { translateX: a3.globals.translateX, translateY: a3.globals.translateY };
        return Math.abs(c2 + n2) > a3.globals.gridWidth ? c2 = a3.globals.gridWidth - n2 : s2.clientX - r2.left < 0 && (c2 = n2), n2 > s2.clientX - r2.left && (l2 = true, c2 = Math.abs(c2)), o2 > s2.clientY - r2.top && (h3 = true, d2 = Math.abs(d2)), g2 = u(u({}, g2 = "x" === i2 ? { x: l2 ? n2 - c2 : n2, y: 0, width: c2, height: a3.globals.gridHeight } : "y" === i2 ? { x: 0, y: h3 ? o2 - d2 : o2, width: a3.globals.gridWidth, height: d2 } : { x: l2 ? n2 - c2 : n2, y: h3 ? o2 - d2 : o2, width: c2, height: d2 }), {}, { translateX: a3.globals.translateX, translateY: a3.globals.translateY }), s2.drawSelectionRect(g2), s2.selectionDragging("resizing"), g2;
    ...
    var wa = function() {
      ...
      return s(t2, [{ key: "moveXCrosshairs", value: function(t3) {
        ...
        i2.globals.isXNumeric ? (n2 && !d2 && (o2 -= s2 % 2 != 0 ? h3 / 2 : 0), n2 && d2 && i2.globals.comboCharts && (o2 -= h3 / 2)) : i2.globals.isBarHorizontal || (o2 = a2.xAxisTicksPositions[t3 - 1] + a2.dataPointsDividedWidth / 2, isNaN(o2) && (o2 = a2.xAxisTicksPositions[t3] - a2.dataPointsDividedWidth / 2)), i2.globals.isBarHorizontal ? l2 -= a2.tooltipRect.ttHeight : i2.config.tooltip.followCursor ? l2 = a2.e.clientY - c2.top - a2.tooltipRect.ttHeight / 2 : l2 + a2.tooltipRect.ttHeight + 15 > i2.globals.gridHeight && (l2 = i2.globals.gridHeight), i2.globals.isBarHorizontal || this.moveXCrosshairs(o2), a2.fixedTooltip || this.moveTooltip(o2, l2 || i2.globals.gridHeight);
      } }]), t2;
    }();
    var ka = function() {
      function t2(e2) {
    ...
    var Ta = function(t2) {
      ...
      return s(a2, [{ key: "draw", value: function(t3, e3, i2) {
        ...
        t3.y;
        var a3 = t3.xDivision, s2 = t3.barWidth, r2 = t3.zeroH, n2 = t3.strokeWidth, o2 = this.w, l2 = new Mi(this.ctx), h3 = e3.i, c2 = e3.j, d2 = true, u2 = o2.config.plotOptions.candlestick.colors.upward, g2 = o2.config.plotOptions.candlestick.colors.downward, p2 = "";
        this.isBoxPlot && (p2 = [this.boxOptions.colors.lower, this.boxOptions.colors.upper]);
        var f2 = this.yRatio[e3.translationsIndex], x2 = e3.realIndex, b2 = this.getOHLCValue(x2, c2), m3 = r2, v2 = r2;
        b2.o > b2.c && (d2 = false);
        var y2 = Math.min(b2.o, b2.c), w3 = Math.max(b2.o, b2.c), k2 = b2.m;
        o2.globals.isXNumeric && (i2 = (o2.globals.seriesX[x2][c2] - o2.globals.minX) / this.xRatio - s2 / 2);
        var A3 = i2 + s2 * this.visibleI;
        void 0 === this.series[h3][c2] || null === this.series[h3][c2] ? (y2 = r2, w3 = r2) : (y2 = r2 - y2 / f2, w3 = r2 - w3 / f2, m3 = r2 - b2.h / f2, v2 = r2 - b2.l / f2, k2 = r2 - b2.m / f2);
        var C2 = l2.move(A3, r2), S2 = l2.move(A3 + s2 / 2, y2);
        return o2.globals.previousPaths.length > 0 && (S2 = this.getPreviousPath(x2, c2, true)), C2 = this.isBoxPlot ? [l2.move(A3, y2) + l2.line(A3 + s2 / 2, y2) + l2.line(A3 + s2 / 2, m3) + l2.line(A3 + s2 / 4, m3) + l2.line(A3 + s2 - s2 / 4, m3) + l2.line(A3 + s2 / 2, m3) + l2.line(A3 + s2 / 2, y2) + l2.line(A3 + s2, y2) + l2.line(A3 + s2, k2) + l2.line(A3, k2) + l2.line(A3, y2 + n2 / 2), l2.move(A3, k2) + l2.line(A3 + s2, k2) + l2.line(A3 + s2, w3) + l2.line(A3 + s2 / 2, w3) + l2.line(A3 + s2 / 2, v2) + l2.line(A3 + s2 - s2 / 4, v2) + l2.line(A3 + s2 / 4, v2) + l2.line(A3 + s2 / 2, v2) + l2.line(A3 + s2 / 2, w3) + l2.line(A3, w3) + l2.line(A3, k2) + "z"] : [l2.move(A3, w3) + l2.line(A3 + s2 / 2, w3) + l2.line(A3 + s2 / 2, m3) + l2.line(A3 + s2 / 2, w3) + l2.line(A3 + s2, w3) + l2.line(A3 + s2, y2) + l2.line(A3 + s2 / 2, y2) + l2.line(A3 + s2 / 2, v2) + l2.line(A3 + s2 / 2, y2) + l2.line(A3, y2) + l2.line(A3, w3 - n2 / 2)], S2 += l2.move(A3, y2), o2.globals.isXNumeric || (i2 += a3), { pathTo: C2, pathFrom: S2, x: i2, y: w3, goalY: this.barHelpers.getGoalValues("y", null, r2, h3, c2, e3.translationsIndex), barXPosition: A3, color: this.isBoxPlot ? p2 : d2 ? [u2] : [g2] };
          ...
          for (var u2 = 0, g2 = e2.config.plotOptions.heatmap.shadeIntensity, p2 = 0; p2 < l2[h3].length; p2++) {
            ...
            if (e2.globals.dataChanged) {
              ...
              if (this.dynamicAnim.enabled && e2.globals.shouldAnimate) {
                ...
                var A3 = e2.globals.previousPaths[h3] && e2.globals.previousPaths[h3][p2] && e2.globals.previousPaths[h3][p2].color;
                A3 || (A3 = "rgba(255, 255, 255, 0)"), this.animateHeatColor(y2, v.isColorHex(A3) ? A3 : v.rgb2hex(A3), v.isColorHex(x2) ? x2 : v.rgb2hex(x2), k2);
              }
            }
            var C2 = (0, e2.config.dataLabels.formatter)(e2.globals.series[h3][p2], { value: e2.globals.series[h3][p2], seriesIndex: h3, dataPointIndex: p2, w: e2 }), S2 = this.helpers.calculateDataLabels({ text: C2, x: u2 + s2 / 2, y: n2 + r2 / 2, i: h3, j: p2, colorProps: b2, series: l2 });
    ...
    var Ua = function() {
      ...
      return s(t2, [{ key: "calculateTimeScaleTicks", value: function(t3, e2) {
        ...
        0 === e2.minHour && 1 === e2.minDate ? (d2 = 0, u2 = v.monthMod(e2.minMonth), o2 = "month", h3 = e2.minDate) : 1 !== e2.minDate && 0 === e2.minHour && 0 === e2.minMinute && (d2 = 0, l2 = e2.minDate, u2 = l2, g2 = c2(h3 = l2, i2, a2)), this.timeScaleArray.push({ position: d2, value: u2, unit: o2, year: this._getYear(a2, g2, 0), month: v.monthMod(g2), day: h3 });
